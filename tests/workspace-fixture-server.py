...
The mock account and three sample notes exist only on this test origin.
"""
...
class Handler(SimpleHTTPRequestHandler):
    ...
    def do_PUT(self):
        ...
        FILES[filename] = json.loads(decoded) if filename.endswith(".json") else {"size": len(decoded)}
